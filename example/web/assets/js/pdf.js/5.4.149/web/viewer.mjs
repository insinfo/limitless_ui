/**
 * C:\MyDartProjects\new_sali\frontend\web\assets\js\pdf.js\5.4.149\web\viewer.mjs
...
const PDFViewerApplication = {
  ...
  async _initializeAutoPrint(pdfDocument, openActionPromise) {
    ...
    // desativa a openAction de arquivos PDF com openAction para imprimir ao abrir
    // MODIFICAÇÃO DEFINITIVA: Comentar este bloco impede a chamada de impressão.
    /*
    if (triggerAutoPrint) {
