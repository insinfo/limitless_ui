...
notificationService.notify(
  ...
  String get outletCardTitle =>
      _isPt ? 'Fluxo real do outlet' : 'Real outlet flow';
  ...
  String get mainInputsTitle =>
      _isPt ? 'Parâmetros úteis' : 'Useful parameters';
  ...
  void showBurst() {
    ...
    notificationService.notify(
      _isPt
          ? 'Existe um item aguardando revisão manual.'
          : 'There is an item waiting for manual review.',
    ...
    notificationService.notify(
      _isPt
          ? 'Clique neste item para abrir o datatable.'
          : 'Click this item to open the datatable.',
