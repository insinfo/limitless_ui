...
class DisclosurePageComponent {
  ...
  String get breadcrumb =>
      _isPt ? 'Accordion, tabs e modal' : 'Accordion, tabs, and modal';
  ...
  String get collapsedStateTitle =>
      _isPt ? 'Estado recolhido' : 'Collapsed state';
  String get collapsedStateDescription => _isPt
      ? 'Começa fechado e expande sob demanda.'
      : 'Starts closed and expands on demand.';
  String get collapsedStateBody => _isPt
      ? 'Ideal para listas longas que precisam manter foco visual.'
      : 'Ideal for long lists that need to preserve visual focus.';
  String get expandedStateTitle =>
      _isPt ? 'Estado expandido' : 'Expanded state';
  String get expandedStateDescription =>
      _isPt ? 'Item inicial aberto.' : 'Initially open item.';
  String get expandedStateBody => _isPt
  ...
  String get alwaysOpenDescription => _isPt
      ? 'Permite comparar seções ao mesmo tempo.'
      : 'Allows comparing sections at the same time.';
  String get alwaysOpenBody => _isPt
      ? 'Ative allowMultipleOpen=true no container principal.'
      : 'Enable allowMultipleOpen=true on the main container.';
  String get tabsModalTitle => _isPt ? 'Tabs e modal' : 'Tabs and modal';
  String get tokensTab => _isPt ? 'Tokens' : 'Tokens';
  String get tokensBody => _isPt
      ? 'Use tabs para separar documentação, exemplos e notas de API no mesmo card.'
      : 'Use tabs to separate documentation, examples, and API notes inside the same card.';
  String get flowTab => _isPt ? 'Fluxo' : 'Flow';
  String get flowBody => _isPt
      ? 'O componente respeita a composição do Bootstrap/Limitless e se encaixa bem em layouts administrativos.'
      : 'The component respects Bootstrap/Limitless composition and fits well in administrative layouts.';
  ...
  String get modalHeading =>
      _isPt ? 'Composição padronizada' : 'Standardized composition';
  String get modalBody => _isPt
