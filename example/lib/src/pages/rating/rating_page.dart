...
<li-rating
  ...
  String get interactiveSnippetTitle => _isPt ? 'Interativo com hover' : 'Interactive with hover';
  String get readonlySnippetTitle => _isPt ? 'Readonly e disabled' : 'Readonly and disabled';
  ...
  String get resettableTitle => _isPt ? 'Resetável e tamanhos' : 'Resettable and sizes';
  ...
  String get readonlyTitle => _isPt ? 'Somente leitura e desabilitado' : 'Readonly and disabled';
  String get readonlyLabel => _isPt ? 'Média consolidada' : 'Consolidated average';
  String get readonlyHelp => _isPt ? 'Exemplo com preenchimento parcial inicial.' : 'Example with an initial partial fill.';
  String get disabledLabel => _isPt ? 'Campo bloqueado' : 'Locked field';
  String get disabledHelp => _isPt ? 'Mantém o valor visível, mas sem interação.' : 'Keeps the value visible, but without interaction.';
