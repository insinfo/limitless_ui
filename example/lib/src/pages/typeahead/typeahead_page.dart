...
class TypeaheadPageComponent {
  ...
  List<Map<String, dynamic>> get cityOptions => _isPt ? _cityOptionsPt : _cityOptionsEn;
  ...
  dynamic remoteSelection;
    ...
    String get pageSubtitle => _isPt ? 'Busca com sugestões' : 'Search with suggestions';
    ...
    String get simpleSearchPlaceholder => _isPt ? 'Busque um estado' : 'Search for a state';
    ...
    String get openOnFocusPlaceholder => _isPt ? 'Foque para navegar pelos estados' : 'Focus to browse states';
    String get selectOnExactTitle => _isPt ? 'Select on exact' : 'Select on exact';
    ...
    String get selectOnExactPlaceholder => _isPt ? 'Digite um estado exato' : 'Type an exact state';
    String get formattedResultsTitle => _isPt ? 'Resultados formatados' : 'Formatted results';
    ...
    String get cityPlaceholder => _isPt ? 'Busque uma cidade' : 'Search for a city';
    String get asyncTitle => _isPt ? 'Busca assíncrona + markup customizado' : 'Async search + custom markup';
    ...
    String get remotePlaceholder => _isPt ? 'Busca remota de cidades' : 'Remote city search';
    String get strictTitle => _isPt ? 'Bloquear entrada manual' : 'Prevent manual entry';
    ...
    String get strictPlaceholder => _isPt ? 'Selecione só nas sugestões' : 'Select only from suggestions';
    String get highlightTitle => _isPt ? 'Highlight configurável' : 'Configurable highlight';
