...
<li-offcanvas #panel offcanvasId="service-demo" title-text="Ações">
  ...
  static const String scrollMarkupSnippet = '''
<li-offcanvas
  position="start"
  size="sm"
  [enableHeader]="false"
  ...
  <process-timeline-panel class="h-100"></process-timeline-panel>
</li-offcanvas>''';

  static const String scrollStylesSnippet = '''
:host {
  display: flex;
  flex: 1 1 auto;
...
.panel-scroll {
  ...
  String get startTitle =>
      _isPt ? 'Esquerda com autofocus' : 'Start with autofocus';
  ...
  String get footerTitle =>
      _isPt ? 'Header e footer customizados' : 'Custom header and footer';
  ...
  String get openServiceButton =>
      _isPt ? 'Abrir via service' : 'Open via service';
  ...
  String get idleEventLog => _isPt
      ? 'Abra um exemplo para validar posição, backdrop, foco e lazy content.'
      : 'Open an example to validate position, backdrop, focus, and lazy content.';
  String get basicPanelTitle =>
      _isPt ? 'Resumo operacional' : 'Operational summary';
  ...
  String get secondaryActionLabel =>
      _isPt ? 'Ação secundária' : 'Secondary action';
  String get configureLaterLabel =>
      _isPt ? 'Configurar depois' : 'Configure later';
  ...
  String get footerPanelTitle =>
      _isPt ? 'Checklist de publicação' : 'Publishing checklist';
  ...
  String get lazyPanelTitle =>
      _isPt ? 'Conteúdo lazy sob demanda' : 'Lazy content on demand';
  String get lazyPanelHeading =>
      _isPt ? 'O que este exemplo valida' : 'What this example validates';
  ...
  String get servicePanelTitle =>
      _isPt ? 'Abertura via service' : 'Opened through service';
  String get serviceFlowTitle =>
      _isPt ? 'Fluxo programático' : 'Programmatic flow';
  ...
  String get dismissProgrammaticLabel =>
      _isPt ? 'Dismiss programático' : 'Programmatic dismiss';
  String get guardedPanelTitle =>
      _isPt ? 'Painel com beforeDismiss' : 'Panel with beforeDismiss';
  ...
  String get allowAutoDismissLabel =>
      _isPt ? 'Permitir dismiss automático' : 'Allow automatic dismiss';
  String get tryDismissLabel => _isPt ? 'Tentar dismiss' : 'Try dismiss';
  String get releaseDismissLabel =>
      _isPt ? 'Liberar e dispensar' : 'Release and dismiss';
  String get closeWithoutDismissLabel =>
      _isPt ? 'Fechar sem dismiss' : 'Close without dismiss';
  String get largePanelTitle =>
      _isPt ? 'Revisão editorial completa' : 'Complete editorial review';
  String get xlReasonTitle =>
      _isPt ? 'Por que usar tamanho xl' : 'Why use xl size';
  ...
  String get monitoredEventsTitle =>
      _isPt ? 'Eventos monitorados' : 'Observed events';
  ...
  void openBasic() {
    basicOffcanvas?.open();
    eventLog =
        _isPt ? 'Offcanvas lateral direito aberto.' : 'Right offcanvas opened.';
  }
