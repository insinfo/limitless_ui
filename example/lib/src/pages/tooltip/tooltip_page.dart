...
<li-tooltip
  ...
  String get autoCloseTitle =>
      _isPt ? 'Fechamento automático' : 'Automatic closing';
  ...
  String get allClicksTooltipText =>
      _isPt ? 'Fecha em qualquer clique.' : 'Closes on any click.';
  String get allClicksButton => _isPt ? 'qualquer clique' : 'all clicks';
  String get containerBodyTitle =>
      _isPt ? 'Anexado ao body' : 'Append tooltip in the body';
  ...
  String get targetedTooltipButton =>
      _isPt ? 'Abrir target customizado' : 'Open custom target';
  String get targetedAnchorLabel =>
      _isPt ? 'Âncora visual do tooltip' : 'Tooltip visual anchor';
  String get templateTitle => _isPt
      ? 'HTML e bindings via TemplateRef'
      : 'HTML and bindings through TemplateRef';
  ...
  String get templateHeader => _isPt
      ? 'TemplateRef dentro do tooltip'
      : 'TemplateRef inside the tooltip';
  ...
  String get templateButton =>
      _isPt ? 'Tooltip com template' : 'Tooltip with template';
  String get delayTitle =>
      _isPt ? 'Abertura e fechamento com delay' : 'Open and close delays';
  ...
  String get customClassButton =>
      _isPt ? 'Tooltip customizado' : 'Custom tooltip';
  String get globalConfigTitle =>
      _isPt ? 'Configuração global' : 'Global configuration';
  ...
  String get configDemoBody => _isPt
      ? 'Neste bloco, os tooltips herdam click, placement="right", autoClose="outside" e uma classe visual própria.'
      : 'In this block, tooltips inherit click, placement="right", autoClose="outside", and a custom visual class.';
  String get configDemoTitle =>
      _isPt ? 'Demo de config global' : 'Global config demo';
