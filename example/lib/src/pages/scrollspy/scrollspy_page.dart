...
<div liScrollSpy #spy="liScrollSpy" (activeChange)="onActiveChange(\$event)">
  ...
  String get syncedMenuTitle =>
      _isPt ? 'Menu sincronizado' : 'Synchronized menu';
  ...
  String get observedContainerTitle =>
      _isPt ? 'Container observado' : 'Observed container';
  ...
  String get directiveSugarTitle =>
      _isPt ? 'Açúcar sintático por diretiva' : 'Directive sugar';
  ...
  String get highlightingTitle =>
      _isPt ? 'Itens em destaque' : 'Highlighting active items';
